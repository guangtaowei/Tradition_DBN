...
from motion import load_data, load_data_ms3
...
def train_crbm(config,
    ...
    for epoch in xrange(training_epochs):
        ...
        # plt.subplot(212)
        # plt.matshow((mf.eval()))
        #plt.imshow(numpy.array(mf), cmap='Greys',  interpolation='nearest')
...
if __name__ == '__main__':
    ...
    scipy.io.savemat('crbmconfig__sean_100h_3p.mat',{'A':crbm.A.get_value(), 'B':crbm.B.get_value(), 'W':crbm.W.get_value(), 'hbias':crbm.hbias.get_value(),'vbias':crbm.vbias.get_value()})
